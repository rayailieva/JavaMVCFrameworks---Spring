...
public class HomeController {
    ...
    private String prepareHtml() throws IOException {
        ...
        if(offers.size() == 0){
            offersHtml
                    .append("<div class=\"apartment\" style=\"border: red solid 1 px\">")
                    .append("There aren't any offers!")
                    .append("</div>");

            return this.htmlReader
                    .readHtml("C:\\Users\\raya\\IdeaProjects\\JavaMVCFrameworks - Spring\\RealEstateAgency\\src\\main\\resources\\static\\index.html")
